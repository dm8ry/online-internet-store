<?php
	...
	if(isset($_POST['subscr_email2']))
	{
		...
		$email = htmlspecialchars (substr($_POST['subscr_email2'], 0, 50));
		...
		if (isValidEmail($email))
		{
			...
			$message = '<html><body>Здравствуйте, Crystalsky!' . '<br/><br/>' . "\r\n".
						 ...
						 'Возможно, ему/ей будет интересно узнать о мероприятиях магазина.<br/>' . "\r\n".	
						 'Можно предложить ему/ей какой-то интересный товар.<br/><br/>' . "\r\n".
						 'С уважением, ' . ' <br/>' . "\r\n".
