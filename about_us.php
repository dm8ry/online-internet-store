...
<html lang="ru">
  <head>
    ...
    <title>магазин "Crystal Sky" - о нас</title>
					...
					<div class="container" style="font-size:16px;">
							...
							<div class="collapse navbar-collapse navHeaderCollapse">
								...
								<ul class="nav navbar-nav navbar-left">
									...
									<li class="active"><a href="about_us.php" style="color:#5a5a5a;">О нас<span class="sr-only">(current)</span></a></li>				
									<li class="dropdown">
	...
	<div class="container"> <!-- start container -->
		...
		<div class="col-md-9">		
			<div id="box" style="background:#ffffff; padding:30px; border-radius: 15px; box-shadow: 2px 2px 3px #888888;">			
				...
				<p class="lead">Серебряные украшения, натуральные камни, позолота. <br/>Самые изысканные украшения для Вас!</p>

				<p>Магазин ювелирных изделий <strong>"Crystal Sky"</strong> — это продажа изделий из серебра 925° и богатый выбор серебряных украшений для Ваc 
				 по самой выгодной цене! Ювелирные серебряные украшения <strong>"Crystal Sky"</strong> созданы для того, чтобы в любой ситуации Вы могли подчеркнуть 
				  свой собственный стиль. Мы понимаем, как важно для Вас сохранить свою индивидуальность.</p>

				<p>Выбор драгоценностей, который мы предлагаем Вам, уникален, ведь новые модели из серебра появляются у нас на постоянной основе, 
				предлагаем посмотреть новые коллекции украшений из серебра!</p>

				<p>Мы следуем тенденциям и потому знаем, что сегодня ни один модный образ невозможен без натуральных драгоценных и полудрагоценных 
				камней. Они наполняют особой магией изделия и украшения из серебра. Цвет и блеск натуральных рубинов, топазов, александритов, сапфиров, 
				аметистов … и многих других камней в серебряных украшениях от  магазина <strong>"Crystal Sky"</strong> становятся изящным акцентом Вашего образа. 
				Серебряная оправа ювелирных изделий тонко подчеркивает природную роскошь камня и моделирует неповторимый стиль ювелирной шикарной коллекции.</p>
				
				<p>Серебряные украшения отличаются утонченным и изысканным внешним видом. Они прекрасно дополнят как вечерний наряд, так и повседневные джинсы и футболку.
				 Серебряные сережки, цепочки, кольца, подвески и браслеты могут стать прекрасным подарком. В ассортименте магазина <strong>"Crystal Sky"</strong> большой выбор украшений из серебра на любой вкус. 
				  Приобретая серебряные ювелирные изделия в нашем магазине, Вы непременно будете довольны!
				</p>
				...
				<div class="row">
					<div class="col-md-3">
						<p class="text-left">
							<img src="assets/images/alex_photo_6.jpg" class="img-rounded img-responsive" alt="">
						</p>
						<p class="text-left">Алекс<br/>Директор магазина<br/>"Crystal Sky"</p>
					</div>
				</div>				
			</div> <!--- end box --->		
		</div>
