...
<html lang="ru">
  <head>
    ...
    <title>магазин "Crystal Sky" - Ваш заказ принят!</title>
	...
	<div class="container"> <!-- start container -->
		...
		<div class="col-md-9">		
			<div id="box" style="background:#ffffff; padding:30px; border-radius: 15px; box-shadow: 2px 2px 3px #888888;">			
				...
				<p>Магазин ювелирных изделий <strong>"Crystal Sky"</strong> принял Ваш заказ.</p> 
				
				<p>Наши операторы уже работают над отправлением заказа для Вас!</p>
			...
			<div class="panel panel-default sidebar-menu" style="border-radius: 15px; box-shadow: 2px 2px 3px #888888;">
				<div class="panel-body">
					<ul class="nav nav-pills nav-stacked ">
						<li>
							<a href="feedbacks.php#come_here">Отзывы покупателей</a>
						</li>
						<li>
							<a href="catalog.php#come_here">Каталог</a>
						</li>	
						<li>
						...
						<li>
							<a href="basket.php#come_here">Корзина покупок</a>
						</li>						
						<li>
							<a href="events.php#come_here">Мероприятия</a>
						</li>						
						<li>
							<a href="blog.php#come_here">Блог</a>
						</li>						
						<li>
							<a href="contact_us.php#come_here">Контакты</a>
						</li>
					</ul>
