...
<html lang="ru">
  <head>
    ...
    <title>магазин "Crystal Sky" - мероприятия</title>
	...
	<div class="container"> <!-- start container -->
		...
		<div class="col-md-9">		
			<div id="box" style="background:#ffffff; padding:30px; border-radius: 15px; box-shadow: 2px 2px 3px #888888;">			
				<h3>Специальные мероприятия от магазина "Crystal Sky"!</h3>

				<hr/>
				
				<div id='ev1'></div>
				<p class="lead">Мероприятие "Пригласите Друзей!"</p>

				<p>Порекомендуйте <strong>магазин ювелирных изделий "Crystal Sky"</strong> своим друзьям в социальных сетях "Одноклассники", "Фейсбук", "ВКонтакте" и др.
				и получите специальный бонус при покупке украшений в нашем магазине!</p>
				...
				<p>Порекомендуйте нас 10-ти друзьям и знакомым и получите специальный "золотой" бонус при покупке украшений!</p>
				
				<br/>
				<div class="row">
					<div class="col-md-12">
						<p class="text-left">
							<img src="assets/images/event_1.jpg" class="img-rounded img-responsive" alt="мероприятие пригласите друзей - магазин Crystal Sky">
						</p>
						<p class="text-left">мероприятие<br/>"Пригласите Друзей"<br/>магазин "Crystal Sky"</p>
					</div>
				</div>	
				...
				<div id='ev2'></div>
				<p class="lead">Мероприятие "Наш Баннер"</p>
				
				<p>Разместите баннер <strong>магазина "Crystal Sky"</strong> на сайте, форуме, в блоге или на странице в социальных сетях "Одноклассники", "Фейсбук", "ВКонтакте" и др.
				и получите специальный бонус при покупке украшений в нашем магазине!</p>
				...
				<div class="row">
					<div class="col-md-12">
						<p class="text-left">
							<img src="assets/images/event_2.png" class="img-rounded img-responsive" alt="мероприятие разместите наш баннер - магазин Crystal Sky">
						</p>
						<p class="text-left">мероприятие<br/>"Наш Баннер"<br/>магазин "Crystal Sky"</p>
					</div>
				</div>					
