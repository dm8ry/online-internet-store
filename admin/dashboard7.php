        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
					...
					<a class="navbar-brand" href="dashboard7.php" style="margin-left:10px;"><span class="glyphicon glyphicon-refresh"></span></a>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card ">
                            <div class="header">
                                <h4 class="title">Заказы магазина "Crystal Sky"</h4>
                                <p class="category">Заказы магазина "Crystal Sky" за последние 90 дней, представлены в обратном порядке по времени.</p>
                            </div>
                            <div class="content"  style="overflow-x:auto;">   
								...
								$sql0="select count(1) n_of_r from businesslog where alert_type='ORDER_FROM_SITE' and datex BETWEEN (NOW() +INTERVAL 10 HOUR- INTERVAL 90 DAY) AND (NOW() +INTERVAL 10 HOUR)";								
								$result0 = $conn->query($sql0);
								$row0 = $result0->fetch_assoc();								
								$total_results = $row0["n_of_r"];									
																								
								$sql = "select * from (select x.*, DATE_FORMAT(x.datex,'%d/%m/%Y %H:%i:%s') as the_date from businesslog x where x.alert_type='ORDER_FROM_SITE' and x.datex between (NOW() +INTERVAL 10 HOUR- INTERVAL 90 DAY) AND (NOW() +INTERVAL 10 HOUR) order by datex desc) M limit ".$p*$n_results_on_page.", ".$n_results_on_page;
								...
								<nav>
								  <ul class="pager">
									<li><a href="dashboard7.php?p=<?php echo $first_page; ?>">Начало</a></li>
									<li><a href="dashboard7.php?p=<?php echo $prv_page; ?>">Предыдущая</a></li>
									<li><a href="dashboard7.php?p=<?php echo $p; ?>">Это <?php echo ($p+1); ?> страница</a></li>
									<li><a href="dashboard7.php?p=<?php echo $nxt_page; ?>">Следующая</a></li>
									<li><a href="dashboard7.php?p=<?php echo $last_page; ?>">Конец</a></li>
								  </ul>
								</nav>
								<!-- pager -->
